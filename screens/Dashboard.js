  ...
  <Stack.Navigator initialRouteName="Dashboard">
    ...
    <Stack.Screen
      ...
      options={{
        ...
        headerStyle: {
          backgroundColor: '#3b5998',  // Yellow-ish green background color
          shadowColor: 'rgba(21, 81, 128, 0.4)',

          shadowOffset: { width: 0, height: 2 },  // Shadow offset
          shadowRadius: 6,  // Shadow blur radius
          elevation: 4,  // For Android devices to show the shadow
        },
        headerTitleStyle: {
          color: 'white',  // Title text color (White to contrast the green)
          fontSize: 24,  // Font size for the title
          fontWeight: 'bold',  // Make title bold
          letterSpacing: 1.2,  // Slight letter spacing for readability
        }, // Set the title to "PresentPath"
      }}
    >
      {() => {
        if (isLoading) {
